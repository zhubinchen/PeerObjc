...
@interface ZHNegotiator () <RTCPeerConnectionDelegate,RTCSessionDescriptionDelegate>
...
- (RTCPeerConnection*)startPeerConnectionWithOptions:(NSDictionary *)options
{
    if (_peerConnection == nil) {
        ...
        if ([_connection.type isEqualToString:@"data"]) {
            ...
            _peerConnection = [_factory peerConnectionWithICEServers:_connection.peer.iceServers constraints:[ZHConstraintsFactory constraintsForDataConnection] delegate:self];
            
        } else if ([_connection.type isEqualToString:@"media"]){
            
            _peerConnection = [_factory peerConnectionWithICEServers:_connection.peer.iceServers constraints:[ZHConstraintsFactory constraintsForMediaConnection] delegate:self];
    ...
    if ([options[@"originator"] isEqualToString:@"true"]) {
        ...
        if ([_connection.type isEqualToString:@"data"]) {
            ...
            [(ZHDataConnection*)_connection initializeDataChannel:dc];
...
- (void)peerConnection:(RTCPeerConnection *)peerConnection addedStream:(RTCMediaStream *)stream
{
    if (stream.videoTracks.count) {
        ...
        [(ZHMediaConnection*)_connection recievedRemoteVideoTrack:videoTrack];
    }
...
- (void)peerConnection:(RTCPeerConnection *)peerConnection didOpenDataChannel:(RTCDataChannel *)dataChannel
{
    ...
    [(ZHDataConnection*)_connection initializeDataChannel:dataChannel];
}
